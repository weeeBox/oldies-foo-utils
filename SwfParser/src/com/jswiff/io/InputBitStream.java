...
public final class InputBitStream {
  ...
  /**
   * Reads an encoded unsigned 1-5 bytes int value
   *
   * @return unsigned encoded int as a long value
   *
   * @throws IOException if an I/O error has occurred
   */
  public long readEncodedU32() throws IOException
  {
	  ...
	  fillBitBuffer();
	  result = (result & 0x0000007f) | bitBuffer<<7;
	  ...
	  fillBitBuffer();
	  result = (result & 0x00003fff) | bitBuffer<<14;
	  ...
	  fillBitBuffer();
	  result = (result & 0x001fffff) | bitBuffer<<21;
	  ...
	  fillBitBuffer();
	  result = (result & 0x0fffffff) | bitBuffer<<28;
	  align();
	  return result;
  }
