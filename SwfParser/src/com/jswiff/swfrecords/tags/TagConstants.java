...
public final class TagConstants {
  ...
  /** Tag code for SymbolClass tag */
  public static final int SYMBOL_CLASS           = 76;
  /** Tag code for DoABC tag */
  public static final int DO_ABC                 = 82;
  /** Tag code for DefineSceneAndFrameLabelData tag */
  public static final int DEFINE_SCENE_AND_FRAME_LABEL_DATA = 86;
  
  /** Tag code for DefineAtlas tag */
  public static final int DEFINE_ATLAS = 100;
  /** Tag code for DefinePackedImage tag */
  public static final int DEFINE_PACKED_IMAGE = 101;
